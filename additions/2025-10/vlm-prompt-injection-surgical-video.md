...
In laparoscopic/surgical video decision support, time-varying visual/textual overlays can collapse
...
- Strip overlay text from OR video via scrub filters and OCR checks before inference.
