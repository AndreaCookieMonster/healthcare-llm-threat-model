...
- See the full roundup: [October 2025 Additions – High-Impact LLM Vulnerabilities in Healthcare](../additions/2025-10/index.md)
- Quick jump links by category:
  - **Prompt injection:** [Medical VLMs (oncology)](../additions/2025-10/vlm-prompt-injection-oncology.md), [Surgical video VLMs](../additions/2025-10/vlm-prompt-injection-surgical-video.md), [Adversarial hallucination attacks in CDS](../additions/2025-10/adversarial-hallucination-attacks-cds.md)
  - **Data poisoning & backdoors:** [Training-data poisoning of medical LLMs](../additions/2025-10/training-data-poisoning-med-llms.md), [BadCLM backdoor in EHR models](../additions/2025-10/badclm-ehr-backdoor.md)
  - **Privacy & disclosure:** [DIRI patient re-identification](../additions/2025-10/patient-reidentification-diri.md), [Radiology report anonymization pitfalls](../additions/2025-10/radiology-report-anonymization-llms.md)
  - **Governance & safety messaging:** [Declining medical safety disclaimers](../additions/2025-10/declining-safety-disclaimers.md)
...
- _October 2025 additions:_ [Medical VLM prompt injection (oncology)](../additions/2025-10/vlm-prompt-injection-oncology.md) · [Surgical video VLM prompt injection](../additions/2025-10/vlm-prompt-injection-surgical-video.md) · [Adversarial hallucination attacks in CDS](../additions/2025-10/adversarial-hallucination-attacks-cds.md)
...
- _October 2025 additions:_ [Medical VLM prompt injection (oncology)](../additions/2025-10/vlm-prompt-injection-oncology.md) · [Surgical video VLM prompt injection](../additions/2025-10/vlm-prompt-injection-surgical-video.md) · [Adversarial hallucination attacks in CDS](../additions/2025-10/adversarial-hallucination-attacks-cds.md) · [DIRI patient re-identification](../additions/2025-10/patient-reidentification-diri.md) · [Radiology report anonymization pitfalls](../additions/2025-10/radiology-report-anonymization-llms.md) · [Declining medical safety disclaimers](../additions/2025-10/declining-safety-disclaimers.md)
...
- _October 2025 additions:_ [Training-data poisoning of medical LLMs](../additions/2025-10/training-data-poisoning-med-llms.md) · [BadCLM backdoor in EHR models](../additions/2025-10/badclm-ehr-backdoor.md)
...
- _October 2025 additions:_ [Medical VLM prompt injection (oncology)](../additions/2025-10/vlm-prompt-injection-oncology.md) · [Training-data poisoning of medical LLMs](../additions/2025-10/training-data-poisoning-med-llms.md) · [BadCLM backdoor in EHR models](../additions/2025-10/badclm-ehr-backdoor.md)
...
- _October 2025 additions:_ [DIRI patient re-identification](../additions/2025-10/patient-reidentification-diri.md) · [Radiology report anonymization pitfalls](../additions/2025-10/radiology-report-anonymization-llms.md)
...
- _October 2025 additions:_ [Adversarial hallucination attacks in CDS](../additions/2025-10/adversarial-hallucination-attacks-cds.md) · [Declining medical safety disclaimers](../additions/2025-10/declining-safety-disclaimers.md)
